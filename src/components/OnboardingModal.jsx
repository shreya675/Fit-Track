            ...
            <div className="popup-content">
             ...
             <button
                  ...
                  onClick={async () => {
                    ...
                    updateUserData({
                      dailySteps: Number(finalData.dailySteps) || 0,
                      dailyWorkout: Number(finalData.dailyWorkout) || 0,
                      dailyCalories: Number(finalData.dailyCalories) || 0,
                      weeklySteps: Number(finalData.weeklySteps) || 0,
                      weeklyWorkout: Number(finalData.weeklyWorkout) || 0,
                      weeklyCalories: Number(finalData.weeklyCalories) || 0,
                    });
